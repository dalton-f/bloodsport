...
var pairs = [
	...
	{
		"buff": {"name": "DOUBLE DAMAGE", "apply": func(p): p.weapon_manager.set_damage_mult(2), "revert": func(p): p.weapon_manager.set_damage_mult(1)},
...
var extremes = [
	...
	{"name": "LOOONGER RANGE", "apply": func(p): p.weapon_manager.set_range_mult(4), "revert": func(p): p.weapon_manager.set_range_mult(1)},
	...
	{"name": "FANTASTICALY FAST", "apply": func(p): p.movement.set_speed_multiplier(3), "revert": func(p): p.movement.set_speed_multiplier(1.0)},
