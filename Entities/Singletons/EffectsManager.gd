...
var pairs = [
	...
	
	{
		...
		"debuff": {"name": "SLOW DOWN", "apply": func(p): p.set_speed_multiplier(0.45), "revert": func(p): p.set_speed_multiplier(1)},
	},
	
	{
		"buff": {"name": "MORE DAMAGE", "apply": func(p): p.weapon_manager.set_damage_mult(2), "revert": func(p): p.weapon_manager.set_damage_mult(1)},
	...
	
	{
		...
		"debuff": {"name": "RANGE DOWN", "apply": func(p): p.weapon_manager.set_range_mult(0.75), "revert": func(p): p.weapon_manager.set_range_mult(0.75)},
	},
...
var extremes = [
	...
	{"name": "LOOONGER RANGE", "apply": func(p): p.weapon_manager.set_range_mult(2.5), "revert": func(p): p.weapon_manager.set_range_mult(1)},
	...
	{"name": "FANTASTICALY FAST", "apply": func(p): p.set_speed_multiplier(2.5), "revert": func(p): p.set_speed_multiplier(1.0)},
